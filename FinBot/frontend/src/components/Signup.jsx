        ...
        <div style={signupCardStyle}>
          <div style={formContainerStyle}>
            ...
            <div style={headerStyle}>
              <h2 style={titleStyle}>
                Your Smarter Financial Journey<br />
                Starts Here
              </h2>
            ...
            <div style={{ textAlign: 'center', marginTop: '1rem', fontSize: '14px', color: '#6b7280' }}>
              <a href="#" style={{ textDecoration: 'none', color: '#6b7280' }}>Security & Privacy Policy</a>
              <span style={{ margin: '0 8px' }}>•</span>
              <a href="#" style={{ textDecoration: 'none', color: '#6b7280' }}>Learn more</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div style={slideshowContainerStyle}>
          ...
          <div style={dotsContainerStyle}>
            {rightImages.map((_, index) => (
              <button
                key={index}
                style={index === activeImageIndex ? activeDotStyle : inactiveDotStyle}
            ...
            <span style={pauseIndicatorStyle}>
              {isPaused ? '⏸️' : ''}
            </span>
          </div>
        </div>
